...
btn_font = pygame.font.SysFont("Comic Sans MS", 20)
guess_font = pygame.font.SysFont("monospace", 24)
lost_font = pygame.font.SysFont('Comic Sans MS', 35)
hint_font = pygame.font.SysFont("serif", 15, italic= True)
word = ''
buttons = []
guessed = []
...
faces = [pygame.image.load('smiley.png'), pygame.image.load('sad.png')]
...
def redraw_game_window():
    ...
    # hint
    label2 = hint_font.render(hint, 1, BLUE)  # "text", antialias, color
    win.blit(label2, (winWidth / 2 - length / 2, 450))
